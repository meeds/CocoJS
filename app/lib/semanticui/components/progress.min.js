...
!function (e, t, n, r) {
    ...
    e.fn.progress = function (t) {
        var a, o = e(this), s = o.selector || "", i = (new Date).getTime(), c = [], l = arguments[0], u = "string" == typeof l, g = [].slice.call(arguments, 1);
        return o.each(function () {
            var o, v, p = e.isPlainObject(t) ? e.extend(!0, {}, e.fn.progress.settings, t) : e.extend({}, e.fn.progress.settings), d = p.className, m = p.metadata, b = p.namespace, f = p.selector, h = p.error, w = "." + b, x = "module-" + b, y = e(this), C = e(this).find(f.bar), T = e(this).find(f.progress), E = e(this).find(f.label), A = this, S = y.data(x), V = !1;
            v = {
                initialize: function () {
                    ...
                    text: function (e) {
                        var t = v.value || 0, n = v.total || 0, r = V ? v.get.displayPercent() : v.percent || 0, a = v.total > 0 ? n - t : 100 - r;
                        ...
                        var e, t = n.createElement("element"), a = {
                        ...
                        var e = C.width(), t = y.width(), n = parseInt(C.css("min-width"), 10), r = e > n ? e / t * 100 : v.percent;
                    ...
                    barWidth: function (e) {
                        ...
                        e = e || p.duration, e = "number" == typeof e ? e + "ms" : e, v.verbose("Setting progress bar transition duration", e), C.css({"transition-duration": e})
                    }, percent: function (e) {
                    ...
                    if (v.debug("Changing setting", t, n), e.isPlainObject(t))e.extend(!0, p, t); else {
                        if (n === r)return p[t];
                        p[t] = n
                    }
                    ...
                    return n = n || g, o = A || o, "string" == typeof t && l !== r && (t = t.split(/[\. ]/), s = t.length - 1, e.each(t, function (n, a) {
                        ...
                        if (e.isPlainObject(l[o]) && n != s)l = l[o]; else {
