...
!function (e, n, o, r) {
    ...
    e.fn.embed = function (o) {
        var t, a = e(this), i = a.selector || "", c = (new Date).getTime(), l = [], d = arguments[0], u = "string" == typeof d, s = [].slice.call(arguments, 1);
        return a.each(function () {
            var m, p = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.embed.settings, o) : e.extend({}, e.fn.embed.settings), f = p.selector, h = p.className, b = p.sources, g = p.error, v = p.metadata, y = p.namespace, w = p.templates, C = "." + y, P = "module-" + y, U = (e(n), e(this)), E = U.find(f.placeholder), S = U.find(f.icon), T = U.find(f.embed), j = this, A = U.data(P);
            m = {
                initialize: function () {
                    ...
                    events: function () {
                        m.has.placeholder() && (m.debug("Adding placeholder events"), U.on("click" + C, f.placeholder, m.createAndShow).on("click" + C, f.icon, m.createAndShow))
                    }
                }, create: function () {
                    var e = m.get.placeholder();
                    e ? m.createPlaceholder() : m.createAndShow()
                }, createPlaceholder: function (e) {
                    var n = m.get.icon(), o = m.get.url();
                    m.generate.embed(o);
                    e = e || m.get.placeholder(), U.html(w.placeholder(e, n)), m.debug("Creating placeholder for embed", e, n)
                }, createEmbed: function (n) {
                    m.refresh(), n = n || m.get.url(), T = e("<div/>").addClass(h.embed).html(m.generate.embed(n)).appendTo(U), p.onCreate.call(j, n), m.debug("Creating embed object", T)
                    ...
                    autoplay: function () {
                        ...
                        var o = !1;
                        return n = n || m.get.url(), n && e.each(b, function (e, r) {
                            return -1 !== n.search(r.domain) ? (o = e, !1) : void 0
                        }), o
                    }, icon: function () {
                        var e = m.get.source();
                        return b[e] !== r ? b[e].icon : !1
                    }, url: function () {
                        var e, n = p.id || U.data(v.id), o = p.source || U.data(v.source);
                        return e = b[o] !== r ? b[o].url.replace("{id}", n) : !1, e && U.data(v.url, e), e
                    }
                }, set: {
                    active: function () {
                        U.addClass(h.active)
                    ...
                    parameters: function (e) {
                        var n, o = [];
                        for (n in e)o.push(encodeURIComponent(n) + "=" + encodeURIComponent(e[n]));
                        return o.join("&amp;")
                    }
                }, generate: {
                    embed: function (e) {
                        m.debug("Generating embed html");
                        var n, o, r = m.get.source();
                        return e = m.get.url(e), e ? (o = m.generate.parameters(r), n = w.iframe(e, o)) : m.error(g.noURL, U), n
                    }, parameters: function (n, o) {
                        var t = b[n] && b[n].parameters !== r ? b[n].parameters(p) : {};
                        return o = o || p.parameters, o && (t = e.extend({}, t, o)), t = p.onEmbed(t), m.encode.parameters(t)
                    }
                }, has: {
                    placeholder: function () {
                        return p.placeholder || U.data(v.placeholder)
                    ...
                    log: function (e) {
                        var n, o, r;
                        p.performance && (n = (new Date).getTime(), r = c || n, o = n - r, c = n, l.push({
                            Name: e[0],
                        ...
                        var n = p.name + ":", o = 0;
                        c = !1, clearTimeout(m.performance.timer), e.each(l, function (e, n) {
                            o += n["Execution Time"]
                    ...
                    var i, c, l, d = A;
                    return o = o || s, a = j || a, "string" == typeof n && d !== r && (n = n.split(/[\. ]/), i = n.length - 1, e.each(n, function (o, t) {
                        var a = o != i ? t + n[o + 1].charAt(0).toUpperCase() + n[o + 1].slice(1) : n;
                        if (e.isPlainObject(d[a]) && o != i)d = d[a]; else {
                            if (d[a] !== r)return c = d[a], !1;
                            if (!e.isPlainObject(d[t]) || o == i)return d[t] !== r ? (c = d[t], !1) : (m.error(g.method, n), !1);
                            d = d[t]
                        }
        ...
        templates: {
            iframe: function (e, n) {
                ...
                var o = "";
                return n && (o += '<i class="' + n + ' icon"></i>'), e && (o += '<img class="placeholder" src="' + e + '">'), o
            }
        },
        api: !0,
        onPause: function () {
