        ...
        return s.each(function () {
            ...
            h = {
                initialize: function () {
                    ...
                    }), d.observe(w, {childList: !0, subtree: !0}), d.observe(e, {
                        childList: !0,
                        subtree: !0
                    }), h.debug("Setting up mutation observer", d))
                    ...
                    load: function () {
                        ...
                        h.stick(t), g.onScroll.call(w)
                    }
                }, refresh: function (e) {
                    h.reset(), g.context || h.determineContext(), e && h.determineContainer(), h.save.positions(), h.stick(), g.onReposition.call(w)
                }, supports: {
                    sticky: function () {
                        var t = e("<div/>");
                        t[0];
                    ...
                    lastScroll: function (e) {
                        ...
                        var e = {height: k.height()}, t = {
                            ...
                            }, offset: S.offset(), width: S.outerWidth(), height: S.outerHeight()
                        }, o = {offset: u.offset(), height: u.outerHeight()};
                        ({height: s.outerHeight()});
                        h.is.standardScroll() || (h.debug("Non-standard scroll. Removing scroll offset from element offset"), e.top = k.scrollTop(), e.left = k.scrollLeft(), t.offset.top += e.top, o.offset.top += e.top, t.offset.left += e.left, o.offset.left += e.left), h.cache = {
                    ...
                    direction: function (e) {
                        var t = "down";
                        return e = e || k.scrollTop(), h.lastScroll !== n && (h.lastScroll < e ? t = "down" : h.lastScroll > e && (t = "up")), t
                        ...
                        e = e || k.scrollTop();
                        var t = h.cache.element, o = h.cache.scrollContext, n = h.get.scrollChange(e), i = t.height - o.height + g.offset, s = h.get.currentElementScroll(), r = s + n;
                        return s = h.cache.fits || 0 > r ? 0 : r > i ? i : r
                    }
                }, remove: {
                    lastScroll: function () {
                        delete h.lastScroll
                    ...
                    offset: function () {
                        ...
                        "HTML" === e || "body" == e ? h.determineContainer() : Math.abs(s.outerHeight() - h.cache.context.height) > g.jitter && (h.debug("Context has padding, specifying exact height for container", h.cache.context.height), s.css({height: h.cache.context.height}))
                    ...
                    log: function (e) {
                        var t, o, n;
                        g.performance && (t = (new Date).getTime(), n = l || t, o = t - n, l = t, c.push({
                            Name: e[0],
                    ...
                    var r, l, c, a = T;
                    return o = o || m, s = w || s, "string" == typeof t && a !== n && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function (o, i) {
                        var s = o != r ? i + t[o + 1].charAt(0).toUpperCase() + t[o + 1].slice(1) : t;
                        if (e.isPlainObject(a[s]) && o != r)a = a[s]; else {
                            if (a[s] !== n)return l = a[s], !1;
                            if (!e.isPlainObject(a[i]) || o == r)return a[i] !== n ? (l = a[i], !1) : !1;
                            a = a[i]
                        }
