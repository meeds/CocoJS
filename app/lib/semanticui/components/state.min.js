...
!function (e, t, n, a) {
    ...
    e.fn.state = function (t) {
        ...
        return o.each(function () {
            var n, f = e.isPlainObject(t) ? e.extend(!0, {}, e.fn.state.settings, t) : e.extend({}, e.fn.state.settings), g = f.error, v = f.metadata, b = f.className, m = f.namespace, x = f.states, p = f.text, h = "." + m, T = m + "-module", y = e(this), w = this, C = y.data(T);
            n = {
                initialize: function () {
                    ...
                    n.verbose("Syncing other buttons to current state"), n.is.active() ? o.not(y).state("activate") : o.not(y).state("deactivate")
                }, get: {
                    text: function () {
                    ...
                    text: function (e, t, a) {
                        var i = n.get.text();
                        n.debug("Flashing text message", e, t), e = e || f.text.flash, t = t || f.flashDuration, a = a || function () {
                    ...
                    text: function () {
                        var e = p.active || y.data(v.storedText), t = p.inactive || y.data(v.storedText);
                    ...
                    text: function (e) {
                        var t = n.get.text();
                        e && e !== t ? (n.debug("Updating text", e), f.selector.text ? y.data(v.storedText, e).find(f.selector.text).text(e) : y.data(v.storedText, e).html(e)) : n.debug("Text is already set, ignoring update", e)
                    }
                    ...
                    var r, c, u, l = C;
                    return o = o || d, s = w || s, "string" == typeof t && l !== a && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function (i, o) {
