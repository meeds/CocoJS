...
!function (e, n, i, t) {
    ...
    e.fn.modal = function (o) {
        var a, r = e(this), s = e(n), c = e(i), l = e("body"), u = r.selector || "", d = (new Date).getTime(), m = [], g = arguments[0], f = "string" == typeof g, h = [].slice.call(arguments, 1), v = n.requestAnimationFrame || n.mozRequestAnimationFrame || n.webkitRequestAnimationFrame || n.msRequestAnimationFrame || function (e) {
                setTimeout(e, 0)
            };
        return r.each(function () {
            var r, b, p, y, k, w, C, M, S, F = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.modal.settings, o) : e.extend({}, e.fn.modal.settings), A = F.selector, D = F.className, H = F.namespace, T = F.error, x = "." + H, z = "module-" + H, O = e(this), q = e(F.context), E = O.find(A.close), j = this, R = O.data(z);
            S = {
                initialize: function () {
                    ...
                    approve: function () {
                        ...
                        var t = e(n.target), o = t.closest(A.modal).length > 0, a = e.contains(i.documentElement, n.target);
                    ...
                    }, S.refreshModals(), S.showModal(n)
                }, hide: function (n) {
                    n = e.isFunction(n) ? n : function () {
                    }, S.refreshModals(), S.hideModal(n)
                }, showModal: function (n) {
                    n = e.isFunction(n) ? n : function () {
                    }, S.is.animating() || !S.is.active() ? (S.showDimmer(), S.cacheSizes(), S.set.position(), S.set.screenHeight(), S.set.type(), S.set.clickaway(), !F.allowMultiple && S.others.active() ? S.hideOthers(S.showModal) : (F.onShow.call(j), F.transition && e.fn.transition !== t && O.transition("is supported") ? (S.debug("Showing modal with css animations"), O.transition({
                        debug: F.debug,
                    ...
                    }, S.debug("Hiding modal"), F.onHide.call(j, e(this)) === !1 ? void S.verbose("Hide callback returned false cancelling hide") : void((S.is.animating() || S.is.active()) && (F.transition && e.fn.transition !== t && O.transition("is supported") ? (S.remove.active(), O.transition({
                        debug: F.debug,
                    ...
                    n = e.isFunction(n) ? n : function () {
                    }, i.length > 0 && (S.debug("Hiding all visible modals"), S.hideDimmer(), i.modal("hide modal", n))
                }, hideOthers: function (n) {
                    var i = b.filter("." + D.active + ", ." + D.animating);
                    n = e.isFunction(n) ? n : function () {
                    }, i.length > 0 && (S.debug("Hiding other modals", b), i.modal("hide modal", n, !0))
                }, others: {
                    active: function () {
                    ...
                    autofocus: function () {
                        var e = O.find(":input").filter(":visible"), n = e.filter("[autofocus]"), i = n.length > 0 ? n.first() : e.first();
                        i.length > 0 && i.focus()
                    }, clickaway: function () {
                    ...
                    log: function (e) {
                        var n, i, t;
                        F.performance && (n = (new Date).getTime(), t = d || n, i = n - t, d = n, m.push({
                            Name: e[0],
                        ...
                        var n = F.name + ":", i = 0;
                        d = !1, clearTimeout(S.performance.timer), e.each(m, function (e, n) {
                            i += n["Execution Time"]
                    ...
                    return i = i || h, o = j || o, "string" == typeof n && l !== t && (n = n.split(/[\. ]/), r = n.length - 1, e.each(n, function (i, o) {
                        ...
                        if (e.isPlainObject(l[a]) && i != r)l = l[a]; else {
            ...
            }, f ? (R === t && S.initialize(), S.invoke(g)) : (R !== t && R.invoke("destroy"), S.initialize())
        }), a !== t ? a : this
    }, e.fn.modal.settings = {
        name: "Modal",
        namespace: "modal",
